...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'lyy在流浪', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '是一只懒羊羊,热爱吃饭睡觉打豆豆🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://raddin.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '记录,分享,博客', // 网站关键词 英文逗号隔开
